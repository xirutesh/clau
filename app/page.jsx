...
function Auth({onLogin,onBack,defaultMode}){
  ...
  return<div style={{minHeight:"100dvh",background:"#e8e8e8",display:"flex",flexDirection:"column"}}><div style={{background:G,padding:"14px 16px",display:"flex",alignItems:"center",gap:10}}><ArrowLeft size={22} color="#fff" style={{cursor:"pointer"}} onClick={onBack}/><span style={{color:"#fff",fontWeight:900,fontSize:18}}>{mode==="login"?"Authorization":"Registration"}</span></div><div style={{flex:1,display:"flex",alignItems:"flex-start",justifyContent:"center",padding:"40px 20px"}}><div style={{background:"#f5f5f5",borderRadius:4,padding:"24px 20px",width:"100%",maxWidth:320,border:"1px solid #ddd"}}>
